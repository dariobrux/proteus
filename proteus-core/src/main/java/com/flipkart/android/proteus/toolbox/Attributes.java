...
public class Attributes
{
    ...
    public static class View
    {
        ...
        public static final String ConstraintBottomToBottom = "layout_constraintBottom_toBottomOf";
        public static final String ConstraintBottomToTop = "layout_constraintBottom_toTopOf";
        public static final String ConstraintEndToEnd = "layout_constraintEnd_toEndOf";
        public static final String ConstraintEndToStart = "layout_constraintEnd_toStartOf";
        public static final String ConstraintHorizontalBias = "layout_constraintHorizontal_bias";
        public static final String ConstraintStartToEnd = "layout_constraintStart_toEndOf";
        public static final String ConstraintStartToStart = "layout_constraintStart_toStartOf";
        public static final String ConstraintTopToBottom = "layout_constraintTop_toBottomOf";
        public static final String ConstraintTopToTop = "layout_constraintTop_toTopOf";
        public static final String ConstraintVerticalBias = "layout_constraintVertical_bias";
