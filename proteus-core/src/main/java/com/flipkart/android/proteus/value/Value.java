...
public abstract class Value
{
    ...
    /**
     * Check if the value is like @layout/b.
     * @return true if b exists.
     */
    public boolean isResourceLayout()
    {
        String[] strings = ((String) ((Primitive) this).getValue()).split("/");
        return strings.length > 1 && strings[0].equals("@layout") && !strings[1].isEmpty();
    }
