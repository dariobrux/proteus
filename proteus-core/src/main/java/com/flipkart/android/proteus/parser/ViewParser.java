...
import com.flipkart.android.proteus.processor.ConstraintAttributeProcessor;
...
public class ViewParser<V extends View> extends ViewTypeParser<V>
{
    ...
    protected void addAttributeProcessors()
    {
        ...
        addAttributeProcessor(Attributes.View.ConstraintStartToStart, new ConstraintAttributeProcessor<V>()
        {
            @Override
            public void setConstraint(@NotNull V view, @NotNull String resource)
            {
                setConstraintOnLayoutAdded(view, resource, ConstraintSet.START, ConstraintSet.START);
            }
        });
        addAttributeProcessor(Attributes.View.ConstraintStartToEnd, new ConstraintAttributeProcessor<V>()
        {
            @Override
            public void setConstraint(@NotNull V view, @NotNull String resource)
            {
                setConstraintOnLayoutAdded(view, resource, ConstraintSet.START, ConstraintSet.END);
            }
        });
        addAttributeProcessor(Attributes.View.ConstraintEndToStart, new ConstraintAttributeProcessor<V>()
        {
            @Override
            public void setConstraint(@NotNull V view, @NotNull String resource)
            {
                setConstraintOnLayoutAdded(view, resource, ConstraintSet.END, ConstraintSet.START);
            }
        });
        addAttributeProcessor(Attributes.View.ConstraintEndToEnd, new ConstraintAttributeProcessor<V>()
        {
            @Override
            public void setConstraint(@NotNull V view, @NotNull String resource)
            {
                setConstraintOnLayoutAdded(view, resource, ConstraintSet.END, ConstraintSet.END);
            }
        });
        addAttributeProcessor(Attributes.View.ConstraintTopToTop, new ConstraintAttributeProcessor<V>()
        {
            @Override
            public void setConstraint(@NotNull V view, @NotNull String resource)
            {
                setConstraintOnLayoutAdded(view, resource, ConstraintSet.TOP, ConstraintSet.TOP);
            }
        });
        addAttributeProcessor(Attributes.View.ConstraintTopToBottom, new ConstraintAttributeProcessor<V>()
        {
            @Override
            public void setConstraint(@NotNull V view, @NotNull String resource)
            {
                setConstraintOnLayoutAdded(view, resource, ConstraintSet.TOP, ConstraintSet.BOTTOM);
            }
        });
        addAttributeProcessor(Attributes.View.ConstraintBottomToTop, new ConstraintAttributeProcessor<V>()
        {
            @Override
            public void setConstraint(@NotNull V view, @NotNull String resource)
            {
                setConstraintOnLayoutAdded(view, resource, ConstraintSet.BOTTOM, ConstraintSet.TOP);
            }
        });
        addAttributeProcessor(Attributes.View.ConstraintBottomToBottom, new ConstraintAttributeProcessor<V>()
        {
            @Override
            public void setConstraint(@NotNull V view, @NotNull String resource)
            {
                setConstraintOnLayoutAdded(view, resource, ConstraintSet.BOTTOM, ConstraintSet.BOTTOM);
            }
        });


        addAttributeProcessor(Attributes.View.ConstraintHorizontalBias, new ConstraintAttributeProcessor<V>()
        {
            @Override
            public void setConstraint(@NotNull V view, @NotNull String resource)
            {
                setHorizontalBias(view, Float.valueOf(resource));
            }
        });
        addAttributeProcessor(Attributes.View.ConstraintVerticalBias, new ConstraintAttributeProcessor<V>()
        {
            @Override
            public void setConstraint(@NotNull V view, @NotNull String resource)
            {
                setVerticalBias(view, Float.valueOf(resource));
            }
        });
    }
